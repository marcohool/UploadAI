...
def main():
    ...
    try:
        ...
        caption = getTextResponse(
            client, "gpt-3.5-turbo-1106", 1, f"Generate a 1 or 2 sentence caption for this image description, describing it briefly, along with a list of total 20 hashtags for social media use. Please reply with this caption and nothing else: '{dallePrompt}'")
